...
const MARQUEE_SCROLL = 'DJ-сеты • Турниры по пиву • Стендап • Караоке • Квизы • Матчи';
...
export default function Menu() {
  ...
  return (
    <section ref={containerRef} id="menu" className="relative w-full h-full overflow-hidden touch-pan-y">
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img
        src="/images/hero2mobile.png"
        alt="Menu mobile background"
        className="absolute inset-0 z-0 w-full h-full object-cover object-center md:hidden pointer-events-none"
      />

      <div className="absolute inset-0 z-0 hidden md:block">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/bg2.png" alt="Menu background" className="w-full h-full object-cover object-center" />
      </div>
      ...
      <motion.div
        ...
        animate={{ x: px * intensity, y: py * (intensity * 0.5) }}
      ...
      >
        ...
        <img
          ...
          alt="Menu title"
          className="w-[clamp(16rem,42vw,59rem)] h-auto"
      ...
      >
        ...
        <img
          ...
          alt="Sticker one"
          className="w-[clamp(12rem,26vw,36rem)] h-auto"
      ...
      >
        ...
        <img
          ...
          alt="Sticker two"
          className="w-[clamp(12rem,24vw,30rem)] h-auto"
          style={{ filter: 'drop-shadow(0 4px 16px rgba(0,0,0,0.5))' }}
        />
      </motion.div>
      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none">
        <motion.button
          type="button"
          className="pointer-events-auto whitespace-nowrap px-6 py-3 border-2 border-[#D4A843] bg-black/90 text-white font-heading text-[clamp(1.2rem,2.2vw,2.3rem)] uppercase tracking-wide shadow-[0_8px_24px_rgba(0,0,0,0.45)]"
