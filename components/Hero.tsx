...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ── Content ── */}
      <div className="relative z-10 flex flex-col items-center justify-start flex-1 px-4 pt-16 md:pt-20 pb-8 text-center">
        {/* Title ЧКХ — /2 size: was 6/10/14rem → 3/5/7rem */}
        <motion.h1
          className="font-hero text-[3rem] md:text-[5rem] lg:text-[7rem] leading-[0.85] uppercase text-textured"
        ...
        {/* ── Steps: icons /1.5, arrows ×2.5, more spacing ── */}
        <motion.div
          ...
          {hero.steps.map((step, i) => (
            <div key={i} className="flex flex-col md:flex-row items-center">
              ...
              <div className="flex flex-col items-center gap-3">
                {/* Icon /1.5: was 36/52/64 → 24/36/44 */}
                <motion.div
                ...
                {/* Label only, centered, ×1.5 size: was 3xl/4xl/5xl → 4xl/6xl/7xl */}
                <p
              ...
              {/* Arrow — ×2.5: was w-20/h-14 lg:w-28/h-20 → w-16/h-12 md:w-36/h-24 lg:w-48/h-32 */}
